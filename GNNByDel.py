...
scheduler = StepLR(optimizer, step_size=50, gamma=0.5)  # 每 50 轮减小学习率一半
...
with torch.no_grad():
    ...
    print(classification_report(data.y.numpy(), pred.numpy(), target_names=[str(i) for i in range(2, 7)]))
    print("\nConfusion Matrix:")
