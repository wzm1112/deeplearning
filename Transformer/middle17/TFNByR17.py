...
# 特征选择与标准化
selected_features = [f"r'{i+1}" for i in range(17)]
target_columns = ["ei"]
...
# 保存模型
torch.save(model.state_dict(), "transformer_model_byR_17.pth")
...
model_loaded.load_state_dict(torch.load("transformer_model_byR_17.pth"))
model_loaded.eval()
